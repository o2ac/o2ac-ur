...
int main(int argc, char* argv[])
{
  ...
  gvl->addRobot("myUrdfRobot", "ur5e/a_bot_simple.urdf", true);

  // Define some joint values:
  robot::JointValueMap min_joint_values;
  min_joint_values["a_bot_shoulder_pan_joint"]  = 0.0;
  min_joint_values["a_bot_shoulder_lift_joint"] = -1.0;
  min_joint_values["a_bot_elbow_joint"]         = -2.0;
  min_joint_values["a_bot_wrist_1_joint"]       = 0.0;
  min_joint_values["a_bot_wrist_2_joint"]       = 0.0;
  min_joint_values["a_bot_wrist_3_joint"]       = 0.0;

  robot::JointValueMap max_joint_values;
  max_joint_values["a_bot_shoulder_pan_joint"]  = 0.1;
  max_joint_values["a_bot_shoulder_lift_joint"] = -1.1;
  max_joint_values["a_bot_elbow_joint"]         = -4.1;
  max_joint_values["a_bot_wrist_1_joint"]       = 0.1;
  max_joint_values["a_bot_wrist_2_joint"]       = 0.1;
  max_joint_values["a_bot_wrist_3_joint"]       = 0.1;
  /*
  ...
  while(true)
  {
    ...
    // std::cout << "min" << min_joint_values << std::endl;
    // std::cout << "max" << max_joint_values << std::endl;
