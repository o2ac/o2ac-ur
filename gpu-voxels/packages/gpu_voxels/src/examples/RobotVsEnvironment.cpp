...
int main(int argc, char* argv[])
{
  ...
  LOGGING_INFO(Gpu_voxels, "Test1" << endl);

  icl_core::logging::initialize(argc, argv);

  LOGGING_INFO(Gpu_voxels, "Test2" << endl);
  /*
  ...
  LOGGING_INFO(Gpu_voxels, "Test3" << endl);
  /*
  ...
  LOGGING_INFO(Gpu_voxels, "Test4" << endl);
  ...
  LOGGING_INFO(Gpu_voxels, "Test5" << endl);
  ...
  LOGGING_INFO(Gpu_voxels, "Test6" << endl);
  /*
