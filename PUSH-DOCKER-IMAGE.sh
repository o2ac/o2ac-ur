...
docker tag ${LOCAL_DOCKER_IMAGE} registry.gitlab.com/${CI_REGISTRY_IMAGE}/o2ac-ur:${DOCKER_FILE_HASH}
docker tag ${LOCAL_DOCKER_IMAGE} registry.gitlab.com/${CI_REGISTRY_IMAGE}/o2ac-ur:latest
...
docker push registry.gitlab.com/${CI_REGISTRY_IMAGE}/o2ac-ur:${DOCKER_FILE_HASH}
docker push registry.gitlab.com/${CI_REGISTRY_IMAGE}/o2ac-ur:latest
