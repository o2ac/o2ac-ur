...
class DynamixelController
{
 ...
 private:
  ...
  bool dynamixelCommandMsgCallback(o2ac_fastening_tools::DynamixelWriteCommand::Request &req,
                                   o2ac_fastening_tools::DynamixelWriteCommand::Response &res);
  
  bool dynamixelReadMsgCallback(o2ac_fastening_tools::DynamixelReadState::Request &req,
