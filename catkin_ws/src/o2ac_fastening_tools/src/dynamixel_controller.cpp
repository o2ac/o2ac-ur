...
bool DynamixelController::dynamixelCommandMsgCallback(o2ac_fastening_tools::DynamixelWriteCommand::Request &req, o2ac_fastening_tools::DynamixelWriteCommand::Response &res)
{
...
bool DynamixelController::dynamixelReadMsgCallback(o2ac_fastening_tools::DynamixelReadState::Request &req, o2ac_fastening_tools::DynamixelReadState::Response &res)
{
	uint8_t motor_id = req.motor_id;
...
DynamixelController::DynamixelController(void)
{
	...
	dynamixel_command_server_ = node_handle_.advertiseService("o2ac_fastening_tools/dynamixel_write_command", &DynamixelController::dynamixelCommandMsgCallback,this);
	dynamixel_info_server_ = node_handle_.advertiseService("o2ac_fastening_tools/dynamixel_read_state", &DynamixelController::dynamixelReadMsgCallback,this);
}
