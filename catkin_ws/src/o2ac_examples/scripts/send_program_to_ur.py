...
def main():
  ...
  pub = rospy.Publisher("/b_bot_controller/ur_hardware_interface/script_command", std_msgs.msg.String, queue_size=1)
  ...
  program_template = open(os.path.join(rospack.get_path("o2ac_examples"), "scripts/ur", "move_back_forth_5cm.script"), 'rb')
