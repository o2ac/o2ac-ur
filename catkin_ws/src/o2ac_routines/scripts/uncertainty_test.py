...
def main():
    ...
    plate_pose = conversions.to_pose_stamped("assembled_part_02", [0, 0, 0, 0, 0, 0,])  # at plate
    ...
    controller.visualize_object_with_distribution(motor_panel_co, pose_with_uncertainty)
