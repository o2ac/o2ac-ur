...
def main():
    ...
    print("eff pose", c.a_bot.get_current_pose_stamped())
    print("NOOOOO")
    pose = c.a_bot.move_lin_rel(relative_translation=[0.0,0.05,0], end_effector_link="knife/knife_tip", pose_only=True)
    print("pose ok??????", pose)
    c.a_bot.go_to_pose_goal(pose, end_effector_link="knife/knife_tip", move_ptp=True)
