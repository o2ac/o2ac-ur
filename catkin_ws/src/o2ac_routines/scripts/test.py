...
def main():
    ...
    controller.fasten_motor(part1=True, part2=False)
    ...
    # controller.orient_bearing("assembly", "a_bot", part1=True, part2=True)
    # controller.insert_bearing("assembled_part_07_inserted", robot_name="a_bot")
    # controller.b_bot.gripper.open(opening_width=0.0105)
    # controller.align_bearing_spacer_pre_insertion("a_bot")
    # controller.orient_bearing_spacer("a_bot")
    # controller.set_assembly(assembly_name="wrs_assembly_2020")
    # controller.subtask_b(simultaneous_execution=False)
    # controller.fasten_bearing("assembly", robot_name="b_bot", with_extra_retighten="True")
...
#     print(a/(1000.0)**5)
    ...
    print("b_bot", np.round(controller.b_bot.robot_group.get_current_joint_values(), 5).tolist())
