...
_KLT_Pyramid
_KLTCreatePyramid(int ncols, int nrows, int subsampling, int nlevels)
{
...
void
_KLTFreePyramid(_KLT_Pyramid pyramid)
{
    int		i;
...
void
_KLTComputePyramid(_KLT_FloatImage img, _KLT_Pyramid pyramid, float sigma_fact)
{
