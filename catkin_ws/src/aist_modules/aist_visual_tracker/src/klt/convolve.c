...
void
_KLTToFloatImage(KLT_PixelType *img,
		 int ncols, int nrows, _KLT_FloatImage floatimg)
{
...
static void
_computeKernels(float sigma,
		ConvolutionKernel *gauss, ConvolutionKernel *gaussderiv)
{
...
void
_KLTGetKernelWidths(float sigma, int *gauss_width, int *gaussderiv_width)
{
...
static void
_convolveImageHoriz(_KLT_FloatImage imgin, ConvolutionKernel kernel,
...
static void
_convolveSeparate(_KLT_FloatImage imgin, ConvolutionKernel horiz_kernel,
...
void
_KLTComputeGradients(_KLT_FloatImage img, float sigma,
...
void
_KLTComputeSmoothedImage(_KLT_FloatImage img, float sigma,
