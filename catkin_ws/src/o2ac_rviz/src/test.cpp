...
public:
    ...
    void setupUi(QWidget *O2ACSetupForm)
    {
        ...
        button_activate_ros_control->setObjectName(QStringLiteral("button_activate_ros_control"));
        ...
        button_open_gripper_a->setObjectName(QStringLiteral("button_open_gripper_a"));

        verticalLayout_a_bot->addWidget(button_open_gripper_a);

        button_close_gripper_a = new QPushButton(a_bot_group);
        button_close_gripper_a->setObjectName(QStringLiteral("button_close_gripper_a"));
        ...
        button_open_gripper_b->setObjectName(QStringLiteral("button_open_gripper_b"));

        verticalLayout_b_bot->addWidget(button_open_gripper_b);

        button_close_gripper_b = new QPushButton(b_bot_group);
        button_close_gripper_b->setObjectName(QStringLiteral("button_close_gripper_b"));
        ...
        base_plate_fixation_group->setObjectName(QStringLiteral("base_plate_fixation_group"));
        ...
        button_open_base_fixation->setObjectName(QStringLiteral("button_open_base_fixation"));

        layout_position->addWidget(button_open_base_fixation);

        button_close_base_fixation = new QPushButton(base_plate_fixation_group);
        button_close_base_fixation->setObjectName(QStringLiteral("button_close_base_fixation"));
        ...
        button_a_bot_m4_pick_screw->setObjectName(QStringLiteral("button_a_bot_m4_pick_screw"));
        QSizePolicy sizePolicy(QSizePolicy::Minimum, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(button_a_bot_m4_pick_screw->sizePolicy().hasHeightForWidth());
        ...
        button_b_bot_m4_pick_screw->setObjectName(QStringLiteral("button_b_bot_m4_pick_screw"));
        ...
        button_a_bot_m4_equip->setObjectName(QStringLiteral("button_a_bot_m4_equip"));
        sizePolicy.setHeightForWidth(button_a_bot_m4_equip->sizePolicy().hasHeightForWidth());
        ...
        button_b_bot_m4_unequip->setObjectName(QStringLiteral("button_b_bot_m4_unequip"));
        ...
        button_b_bot_m4_equip->setObjectName(QStringLiteral("button_b_bot_m4_equip"));
        sizePolicy.setHeightForWidth(button_b_bot_m4_equip->sizePolicy().hasHeightForWidth());
        ...
        button_a_bot_m4_unequip->setObjectName(QStringLiteral("button_a_bot_m4_unequip"));
        ...
        button_tighten_nut_5s->setObjectName(QStringLiteral("button_tighten_nut_5s"));
        ...
        button_tighten_m2s_5s->setObjectName(QStringLiteral("button_tighten_m2s_5s"));
        ...
        button_a_bot_nut_equip->setObjectName(QStringLiteral("button_a_bot_nut_equip"));
        sizePolicy.setHeightForWidth(button_a_bot_nut_equip->sizePolicy().hasHeightForWidth());
        ...
        button_a_bot_m2s_unequip->setObjectName(QStringLiteral("button_a_bot_m2s_unequip"));
        ...
        button_b_bot_m2s_equip->setObjectName(QStringLiteral("button_b_bot_m2s_equip"));
        sizePolicy.setHeightForWidth(button_b_bot_m2s_equip->sizePolicy().hasHeightForWidth());
    ...
    {
        O2ACSetupForm->setWindowTitle(QApplication::translate("O2ACSetupForm", "Form", Q_NULLPTR));
        button_activate_ros_control->setText(QApplication::translate("O2ACSetupForm", "Activate UR ROS control", Q_NULLPTR));
        button_robots_home->setText(QApplication::translate("O2ACSetupForm", "Robots go home", Q_NULLPTR));
        a_bot_group->setTitle(QApplication::translate("O2ACSetupForm", "a_bot", Q_NULLPTR));
        button_home_a_bot->setText(QApplication::translate("O2ACSetupForm", "Home", Q_NULLPTR));
        button_open_gripper_a->setText(QApplication::translate("O2ACSetupForm", "Open", Q_NULLPTR));
        button_close_gripper_a->setText(QApplication::translate("O2ACSetupForm", "Close", Q_NULLPTR));
        b_bot_group->setTitle(QApplication::translate("O2ACSetupForm", "b_bot", Q_NULLPTR));
        button_home_b_bot->setText(QApplication::translate("O2ACSetupForm", "Home", Q_NULLPTR));
        button_open_gripper_b->setText(QApplication::translate("O2ACSetupForm", "Open", Q_NULLPTR));
        button_close_gripper_b->setText(QApplication::translate("O2ACSetupForm", "Close", Q_NULLPTR));
        base_plate_fixation_group->setTitle(QApplication::translate("O2ACSetupForm", "Base plate", Q_NULLPTR));
        button_open_base_fixation->setText(QApplication::translate("O2ACSetupForm", "Open", Q_NULLPTR));
        button_close_base_fixation->setText(QApplication::translate("O2ACSetupForm", "Close", Q_NULLPTR));
        tool_group_box->setTitle(QApplication::translate("O2ACSetupForm", "Tools", Q_NULLPTR));
        tool_header_vac->setText(QApplication::translate("O2ACSetupForm", "Vac", Q_NULLPTR));
        button_a_bot_m4_pick_screw->setText(QApplication::translate("O2ACSetupForm", "a_bot", Q_NULLPTR));
        button_b_bot_m4_pick_screw->setText(QApplication::translate("O2ACSetupForm", "b_bot", Q_NULLPTR));
        tool_row_m4->setText(QApplication::translate("O2ACSetupForm", "M4", Q_NULLPTR));
        button_loosen_m4_1s->setText(QApplication::translate("O2ACSetupForm", "1s", Q_NULLPTR));
        button_a_bot_m4_equip->setText(QApplication::translate("O2ACSetupForm", "a_bot", Q_NULLPTR));
        label_tool_m3_alive->setText(QApplication::translate("O2ACSetupForm", "\342\235\214", Q_NULLPTR));
        button_b_bot_m4_unequip->setText(QApplication::translate("O2ACSetupForm", "b_bot", Q_NULLPTR));
        tool_header_alive->setText(QApplication::translate("O2ACSetupForm", "Alive", Q_NULLPTR));
        tool_header_loosen->setText(QApplication::translate("O2ACSetupForm", "Unscr.", Q_NULLPTR));
        tool_row_m3->setText(QApplication::translate("O2ACSetupForm", "M3", Q_NULLPTR));
        button_b_bot_m4_equip->setText(QApplication::translate("O2ACSetupForm", "b_bot", Q_NULLPTR));
        button_tighten_m4_5s->setText(QApplication::translate("O2ACSetupForm", "5s", Q_NULLPTR));
        button_a_bot_m4_unequip->setText(QApplication::translate("O2ACSetupForm", "a_bot", Q_NULLPTR));
        tool_header_pick->setText(QApplication::translate("O2ACSetupForm", "Pick", Q_NULLPTR));
        tool_header_equip->setText(QApplication::translate("O2ACSetupForm", "Equip", Q_NULLPTR));
        label_tool_m3_vac->setText(QApplication::translate("O2ACSetupForm", "\342\236\226", Q_NULLPTR));
        tool_header_unequip->setText(QApplication::translate("O2ACSetupForm", "Uneq.", Q_NULLPTR));
        label_tool_m4_vac->setText(QApplication::translate("O2ACSetupForm", "\342\236\226", Q_NULLPTR));
        button_loosen_m3_1s->setText(QApplication::translate("O2ACSetupForm", "1s", Q_NULLPTR));
        button_tighten_m3_5s->setText(QApplication::translate("O2ACSetupForm", "5s", Q_NULLPTR));
        label_tool_m4_alive->setText(QApplication::translate("O2ACSetupForm", "\342\235\214", Q_NULLPTR));
        tool_row_nut->setText(QApplication::translate("O2ACSetupForm", "Nut", Q_NULLPTR));
        tool_header_tighten->setText(QApplication::translate("O2ACSetupForm", "Screw", Q_NULLPTR));
        tool_row_m2s->setText(QApplication::translate("O2ACSetupForm", "M2s", Q_NULLPTR));
        label_tool_nut_alive->setText(QApplication::translate("O2ACSetupForm", "\342\235\214", Q_NULLPTR));
        label_tool_m2s_alive->setText(QApplication::translate("O2ACSetupForm", "\342\235\214", Q_NULLPTR));
        button_tighten_nut_5s->setText(QApplication::translate("O2ACSetupForm", "5s", Q_NULLPTR));
        button_tighten_m2s_5s->setText(QApplication::translate("O2ACSetupForm", "5s", Q_NULLPTR));
        button_loosen_nut_1s->setText(QApplication::translate("O2ACSetupForm", "1s", Q_NULLPTR));
        button_loosen_m2s_1s->setText(QApplication::translate("O2ACSetupForm", "1s", Q_NULLPTR));
        button_a_bot_nut_equip->setText(QApplication::translate("O2ACSetupForm", "a_bot", Q_NULLPTR));
        button_a_bot_m2s_unequip->setText(QApplication::translate("O2ACSetupForm", "a_bot", Q_NULLPTR));
        button_close_b_8->setText(QApplication::translate("O2ACSetupForm", "b_bot", Q_NULLPTR));
        button_b_bot_m2s_equip->setText(QApplication::translate("O2ACSetupForm", "b_bot", Q_NULLPTR));
        label_tool_nut_vac->setText(QApplication::translate("O2ACSetupForm", "\342\236\226", Q_NULLPTR));
        label_tool_m2s_vac->setText(QApplication::translate("O2ACSetupForm", "\342\236\226", Q_NULLPTR));
    } // retranslateUi
