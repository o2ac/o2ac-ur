...
extra_joint_filename = os.path.join(rp.get_path("o2ac_parts_description"), "config", "extra_frames.csv")
...
spawn_template_filename = os.path.join(rp.get_path("o2ac_parts_description"), "urdf/templates", "gazebo_spawn_template.urdf")
