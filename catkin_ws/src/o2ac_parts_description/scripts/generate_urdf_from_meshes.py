...
# Read in the files
filenames = os.listdir(os.path.join(rp.get_path("o2ac_parts_description"), "meshes"))
filenames_strip1 = []
filenames_no_ext = []
...
extra_joint_filename = os.path.join(rp.get_path("o2ac_parts_description"), "urdf/templates", "extra_frames.csv")
macro_template_filename = os.path.join(rp.get_path("o2ac_parts_description"), "urdf/templates", "macro_template.urdf.xacro")
f = open(macro_template_filename,'r')
macro_template = f.read()
f.close()

macro_frames_only_template_filename = os.path.join(rp.get_path("o2ac_parts_description"), "urdf/templates", "macro_frames_only_template.urdf.xacro")
f = open(macro_frames_only_template_filename,'r')
macro_frames_only_template = f.read()
f.close()

non_macro_template_filename = os.path.join(rp.get_path("o2ac_parts_description"), "urdf/templates", "non_macro_template.urdf.xacro")
f = open(non_macro_template_filename,'r')
non_macro_template = f.read()
f.close()

spawn_template_filename = os.path.join(rp.get_path("o2ac_parts_description"), "urdf/templates", "spawn_template.urdf")
