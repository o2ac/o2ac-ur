...
class ExampleState(EventState):
    ...
    def on_enter(self, userdata):
        ...
        # It is primarily used to start actions which are associated with this
        # state.

        # The following code is just for illustrating how the behavior logger works.
        # Text logged by the behavior logger is sent to the operator and
        # displayed in the GUI.

        time_to_wait = (self._target_time -
                        (rospy.Time.now() - self._start_time)).to_sec()
    ...
    def on_exit(self, userdata):
        ...
        # It can be used to stop possibly running processes started by
        # on_enter.
